...
printf "compiling assignment classes ...\n"
gcc -c ./Assignment/Assignment_view.cpp -o ./object_files/Assignment_view.o -lstdc++
gcc -c ./Assignment/Assignment_model.cpp -o ./object_files/Assignment_model.o -lstdc++
gcc -c ./Assignment/Assignment_controler.cpp -o ./object_files/Assignment_controler.o -lstdc++
gcc -c ./Assignment/Assignment_MVC.cpp -o ./object_files/Assignment_MVC.o -lstdc++
printf "compiling assignment classes complete\n"
...
printf "linking to create a.out ...\n"
gcc ./object_files/main.o ./object_files/Assignment_view.o ./object_files/Assignment_model.o ./object_files/Assignment_controler.o ./object_files/Assignment_MVC.o ./object_files/helper_functions.o -lstdc++
printf "done (:)\n"
